      ...
      <div className={`min-h-screen ${isDarkMode ? 'bg-[#0F0F0F] text-white' : 'bg-slate-50 text-slate-900'} flex transition-colors duration-500`}>
        ...
        <div className="md:hidden fixed top-0 left-0 right-0 h-16 bg-white dark:bg-black z-30 flex items-center justify-between px-5 border-b border-black/10 dark:border-white/10">
          <div className="flex items-center gap-2">
            <div className="w-9 h-9 rounded-lg bg-[#07308D] p-1.5 shadow-lg shadow-[#07308D]/20 flex items-center justify-center shrink-0">
          ...
          <div className="mb-12 flex items-center justify-between">
            <div>
              <div className="flex items-center gap-2 mb-3">
                <div className="w-10 h-10 rounded-xl bg-[#07308D] p-1.5 shadow-lg shadow-[#07308D]/20 flex items-center justify-center shrink-0">
                  <img src="/maink.png" alt="Icon" className="w-full h-full object-contain" />
                </div>
                <div className="relative h-[1.8rem] aspect-[4.5/1] transition-all duration-300 ml-2">
                  <img src="/title .png" alt="The Inkspire" className="absolute inset-0 w-full h-full object-contain brightness-0 dark:hidden" />
                  <img src="/title .png" alt="" className="absolute inset-0 w-full h-full object-contain dark:hidden" style={{ clipPath: 'inset(40% 0 0 38%)' }} />
                  <img src="/title .png" alt="The Inkspire" className="absolute inset-0 w-full h-full object-contain hidden dark:block" />
                </div>
          ...
          <div className="mt-auto border-t border-white/10 pt-6 flex flex-col gap-2">
            ...
            <button
              ...
              className={`flex items-center gap-3 px-4 py-3 text-[11px] uppercase tracking-widest font-bold rounded transition-colors ${
                isSplit 
                  ? 'bg-[#07308D] text-white shadow-lg shadow-[#07308D]/20' 
          ...
          <div className="h-16 shrink-0 bg-black flex items-center justify-between px-6 border-b border-white/10">
             ...
             <div className="flex items-center gap-4">
                <a 
                  href="/" 
                  target="_blank"
                  className="text-[9px] uppercase tracking-widest text-[#07308D] font-bold hover:text-white transition-colors"
                >
                  Open in Tab ↗
                </a>
                <button 
